...
export const TicketSuccessView = ({
  ...
  return (
    <div className="flex flex-col items-center bg-soft-dark justify-center">
      ...
      <div
        ref={ticketRef}
        className="w-full flex flex-col items-center space-y-6 p-8"
      >
        <div className="text-center">
          <p className="text-xs uppercase font-bold text-gray2 tracking-[0.2em]">
        ...
        <div className="w-full bg-white/5 border-2 border-dashed border-white/10 p-6 rounded-2xl relative">
          <div className="text-center space-y-1 mb-4">
            <p className="text-[10px] uppercase font-black text-gray3">
              Ticket Number
            </p>
            <p className="text-4xl font-black text-primary tracking-tighter uppercase">
              {ticketNumber}
            </p>
          </div>
          ...
          <div className="flex justify-between border-t border-white/10 pt-4">
            ...
            <TicketDetail label="Trip Status" value="BOOKED" isPrimary />
          </div>
        </div>
      </div>
      ...
      <div className="w-full space-y-3 px-8">
        <button
          ...
          className="w-full h-14 bg-white/5 border border-white/10 rounded-xl flex items-center justify-center gap-3 hover:bg-white/10 transition-all active:scale-95 disabled:opacity-50"
        >
          {isDownloading ? (
        ...
        <button
          onClick={onClose}
          className="primary-btn w-full h-14 rounded-xl tracking-widest text-sm font-black uppercase"
        >
          Done & Close
        </button>
      </div>
