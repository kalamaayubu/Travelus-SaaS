  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-8">
      <header>
        ...
        <p className="text-gray5 text-sm font-medium">
      ...
      <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-green-500 to-green-700 p-1">
        <div className="bg-soft-dark rounded-[1.9rem] p-6">
          ...
          <div className="flex justify-between items-center mb-8">
            <div className="text-center">
              ...
              <p className="text-[10px] text-gray5 uppercase font-bold">
                Nairobi
              </p>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4 pt-6 border-t border-white/5">
            <div className="flex items-center gap-3 text-gray4">
      ...
      <div className="space-y-4">
        <h3 className="text-xs font-bold text-gray5 uppercase tracking-widest">
          Travel History
        </h3>
        {[1, 2].map((_, i) => (
          <div
            key={i}
            className="group flex items-center justify-between p-5 rounded-2xl bg-soft-dark border border-white/5 hover:border-white/10 transition-all cursor-pointer"
          >
            <div className="flex items-center gap-4">
              <div className="size-10 rounded-xl bg-white/5 flex items-center justify-center text-gray5">
              ...
              <div>
                ...
                <p className="text-[10px] text-gray5">
                  Completed on 12 Nov 2025
                </p>
              </div>
            </div>
            <ChevronRight className="size-4 text-gray6 group-hover:text-white transition-colors" />
          </div>
        ))}
      </div>
    </div>
