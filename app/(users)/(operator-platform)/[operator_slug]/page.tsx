  ...
  return (
    <div className="min-h-screen p-4 md:p-8 space-y-8 max-w-[1600px] mx-auto">
      ...
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <div className="relative hidden xl:block">
            ...
            <input
              className="bg-bg-soft border border-white/5 rounded-full py-2 pl-10 pr-4 text-sm focus:border-secondary outline-none w-64"
              placeholder="Search vehicle or driver..."
            />
          </div>
          <button className="p-3 rounded-full bg-bg-soft border border-white/5 text-gray-400 hover:text-secondary relative">
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-12 lg:col-span-8 p-8 rounded-xl bg-bg-soft border border-white/5 flex flex-col justify-between relative overflow-hidden group">
        ...
        <div className="col-span-12 lg:col-span-4 p-8 rounded-xl bg-gradient-to-br from-secondary/20 to-bg-soft border border-secondary/20">
          ...
          <div className="space-y-6">
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-3">
                ...
                <span className="text-gray-300">Active on Road</span>
              </div>
        ...
        <div className="col-span-12 xl:col-span-7 rounded-xl bg-bg-soft border border-white/5 overflow-hidden">
        ...
        <div className="col-span-12 xl:col-span-5 space-y-6">
          ...
          <div className="p-8 rounded-xl bg-bg-soft border border-white/5">
